...
[1] 
(MoCIDet_env) irene@irenes:~/MoCIDet$ python3.7 MoCIDet.py -data_path test_anon/multi-dicom/NORM210 -data_type 'multi-dicom' -save_file 'test_multi-dicom' -display -save_slice
test_anon/multi-dicom/NORM210 0.24444444444444444
Time:  14.42564868927002
[['test_anon/multi-dicom/NORM210' '0.24444444444444444']]

[2]
(MoCIDet_env) irene@irenes:~/MoCIDet$ python3.7 MoCIDet.py -data_path test_anon/multi-dicom/ -data_type 'multi-dicom' -save_file 'test_multi-dicom2' -display -save_slice
test_anon/multi-dicom/NORM210 0.24444444444444444
...
[3]
(MoCIDet_env) irene@irenes:~/MoCIDet$ python3.7 MoCIDet.py -data_path test_anon/multi-dicom/NORM210 -data_type 'dicom-2D' -save_file 'test_dicom_2D' -display -save_slice
test_anon/multi-dicom/NORM210 0.16666666666666666
Time:  6.983335971832275
[['test_anon/multi-dicom/NORM210' '0.16666666666666666']]

[4]
(MoCIDet_env) irene@irenes:~/MoCIDet$ python3.7 MoCIDet.py -data_path test_anon/multi-dicom/ -data_type 'dicom-2D' -save_file 'test_dicom_2D2' -display -save_slice
test_anon/multi-dicom/NORM210 0.16666666666666666
...
[5]
(MoCIDet_env) irene@irenes:~/MoCIDet$ python3.7 MoCIDet.py -data_path test_anon/dicom/ -data_type 'dicom' -save_file 'test_dicom' -display -save_slice
...
[6]
(MoCIDet_env) irene@irenes:~/MoCIDet$ python3.7 MoCIDet.py -data_path test_anon/nifti_from_dicom/ -data_type 'nifti' -save_file 'test_nifti_from_dicom' -display -save_slice
...
[7]
Same dicom files above converted to nifti.
(MoCIDet_env) irene@irenes:~/MoCIDet$ python3.7 MoCIDet.py -data_path test_anon/nifti/ -data_type 'nifti' -save_file 'test_nifti' -display -save_slice
...
[['test_anon/nifti/ABIDE_50002_MRI_MP-RAGE_br_raw_20120830172854796_S164623_I328631.nii'
  '1.0']
 ['test_anon/nifti/ABIDE_50003_MRI_MP-RAGE_br_raw_20120830155445855_S164416_I328410.nii'
  '1.0']
 ['test_anon/nifti/sub-10159_T1w.nii.gz' '1.0']
 ['test_anon/nifti/sub-10206_T1w.nii.gz' '0.05185185185185185']]
